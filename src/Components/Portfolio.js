...
const Portfolio = () => {
    const projects = [
        ...
        },
        {
            ...
            git: "#",
            description: "This is a landing page was built for a gaming company. This includes a login component that validates the email address entered by the user and if the email is valid, stores the email address on a dummy database, created on firebase."
        },
        {
            id: "d2",
            image: academy,
            ...
            git: "#",
            description: "This is a fully responsive static school website built with HTML, CSS and Bootstrap."
        },
    ]
